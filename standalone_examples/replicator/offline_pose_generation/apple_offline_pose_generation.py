...
CONFIG_FILES = {"dope": "config/dope_config.yaml", "ycbvideo": "config/apples_config.yaml"}
TEST_CONFIG_FILES = {"dope": "tests/dope/test_dope_config.yaml", "ycbvideo": "tests/apples/test_ycb_config.yaml"}
